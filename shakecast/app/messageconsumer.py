...
class Consumer(object):
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        # We don't want to acknowledge messages so we can use one instance of PDL
...
class ReconnectingConsumer(object):
    ...
    def __init__(self, amqp_url, ConsumerClass=Consumer):
        self._reconnect_delay = 0
        self._amqp_url = amqp_url
        self.consumer = ConsumerClass(self._amqp_url)
    ...
    def _maybe_reconnect(self):
        if self.consumer.should_reconnect:
            ...
            self.consumer = self.ConsumerClass(self._amqp_url)
